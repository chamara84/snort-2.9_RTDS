...
static void SnortReset(void)
{
    ...
    {
        idxPreprocReset->sfunc(-1, idxPreprocReset->arg);
    ...
    {
        idxPreprocResetStats->sfunc(-1, idxPreprocResetStats->arg);
...
static void SnortCleanup(int exit_val)
{
    ...
    while (idxPreproc)
    {
        idxPreproc->sfunc(SIGQUIT, idxPreproc->arg);
    ...
    while(idxPlugin)
    {
        idxPlugin->sfunc(SIGQUIT, idxPlugin->arg);
